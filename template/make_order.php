    ...
    <div class="shop-page__wrapper">
      ...
      <form action="#" method="post" class="custom-form js-order">
        ...
        <fieldset class="custom-form__group js-radio">
          ...
          <input id="dev-no" class="custom-form__radio" type="radio" name="is_delivery" value="<?= DELIVERY_NO ?>" checked="">
          <label for="dev-no" class="custom-form__radio-label">Самовывоз</label>
          <input id="dev-yes" class="custom-form__radio" type="radio" name="is_delivery" value="<?= DELIVERY_YES ?>">
        ...
        <fieldset class="custom-form__group shop-page__pay">
          ...
          <input id="cash" class="custom-form__radio" type="radio" name="payment_type" value="<?= PAYMENT_CASH ?>">
          <label for="cash" class="custom-form__radio-label">Наличные</label>
          <input id="card" class="custom-form__radio" type="radio" name="payment_type" value="<?= PAYMENT_CARD ?>" checked="">
        ...
        <button class="button" type="submit" name="make_order">Отправить заказ</button>
      </form>
    </div>
</section>
